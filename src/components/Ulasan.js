...
const Ulasan = () => {
  return (
    ...
    <div className="review-page">
      ...
      <p style={{width: 280, height: 300, left: 565, top: 470, position: 'absolute', borderRadius: 10}}>Curug Cilembu</p>
      <p style={{width: 280, height: 300, left: 920, top: 470, position: 'absolute', borderRadius: 10}}>Curug Pangeran</p>
      <section className="testimoni">
        ...
        <div className="box-container">
          <div className="box-1">
            <figure>
              <img style={{width: 280, height: 300, left: 138, top: 150, position: 'absolute', borderRadius: 10}} src={leuwiHejo} alt="Gambar 1 - Curug Leuwi Hejo" />
          ...
          <div className="box-2">
            <figure>
              <img style={{width: 280, height: 300, left: 490, top: 150, position: 'absolute', borderRadius: 10}} src={cilembu} alt="Gambar 2 - Curug Cilembu" />
          ...
          <div className="box-3">
            <figure>
              <img style={{width: 280, height: 300, left: 843, top: 150, position: 'absolute', borderRadius: 10}} src={pangeran} alt="Gambar 3 - Curug Pangeran" />
